...
> 作者与维护者：[不坑老师](https://github.com/44886)
...
**不坑老师**是一名持续探索教育实践与 AI 工具结合的教师创作者。本项目源于对真实家长会 HTML 演示文稿的反复打磨，并将其中验证有效的内容提炼、风格选择、翻页笔交互、分步叙事和离线交付方法整理成可复用的 Codex Skill。

- GitHub：[@44886](https://github.com/44886)
- 项目维护：不坑老师
